...
public class LayoutFlow extends ViewGroup {
    ...
    public LayoutFlow(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);

        this.readStyleParameters(context, attributeSet);
    }

    public LayoutFlow(Context context, AttributeSet attributeSet, int defStyle) {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        TypedArray a = context.obtainStyledAttributes(attributeSet, R.styleable.LayoutFlow);
        try {
            horizontalSpacing = a.getDimensionPixelSize(R.styleable.LayoutFlow_horizontalSpacing, 0);
            verticalSpacing = a.getDimensionPixelSize(R.styleable.LayoutFlow_verticalSpacing, 0);
            orientation = a.getInteger(R.styleable.LayoutFlow_orientation, HORIZONTAL);
            debugDraw = a.getBoolean(R.styleable.LayoutFlow_debugDraw, false);
        } finally {
            a.recycle();
        }
    }
